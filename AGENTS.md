...
- **SDK version**: the sample uses `@faultlenshq/browser@0.1.0-beta.3`, `@faultlenshq/angular@0.1.0-beta.2`, and `@faultlenshq/react@0.1.0-beta.1`. Do not bump SDK versions unless the issue explicitly requires it.
